...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeDietPageToToday() {
        ...
        if (todayCells.length > 0) {
            ...
            // 渲染今天的飲食和水量
            if (typeof window.renderFoodListByDate === "function") {
                window.renderFoodListByDate(todayStr);
            }

            if (typeof window.renderWaterByDate === "function") {
                window.renderWaterByDate(todayStr);
            }
